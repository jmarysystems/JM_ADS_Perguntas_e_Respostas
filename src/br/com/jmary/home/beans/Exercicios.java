...
@NamedQueries({
    ...
    , @NamedQuery(name = "Exercicios.findByEnderecoExternoImagemTextoAuxiliar", query = "SELECT e FROM Exercicios e WHERE e.enderecoExternoImagemTextoAuxiliar = :enderecoExternoImagemTextoAuxiliar")
...
public class Exercicios implements Serializable {
    ...
    @Column(name = "ENDERECO_EXTERNO_IMAGEM_TEXTO_AUXILIAR", length = 300)
    private String enderecoExternoImagemTextoAuxiliar;
    @Basic(optional = false)
    ...
    public Exercicios(Integer id, String pergunta, String respostaA, String respostaB, String respostaC, String respostaD, String letraDaRespostaCorreta, int idAssunto) {
        this.id = id;
    ...
    public String getEnderecoExternoImagemTextoAuxiliar() {
        return enderecoExternoImagemTextoAuxiliar;
    }

    public void setEnderecoExternoImagemTextoAuxiliar(String enderecoExternoImagemTextoAuxiliar) {
        String oldEnderecoExternoImagemTextoAuxiliar = this.enderecoExternoImagemTextoAuxiliar;
        this.enderecoExternoImagemTextoAuxiliar = enderecoExternoImagemTextoAuxiliar;
        changeSupport.firePropertyChange("enderecoExternoImagemTextoAuxiliar", oldEnderecoExternoImagemTextoAuxiliar, enderecoExternoImagemTextoAuxiliar);
    }
