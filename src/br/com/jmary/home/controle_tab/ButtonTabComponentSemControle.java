...
public class ButtonTabComponentSemControle extends JPanel {
    private final JTabbedPane tabFrame2;

    public ButtonTabComponentSemControle(final JTabbedPane pane, String titulo, ImageIcon icon ) {
        ...
        JLabel lbTituloTab = new JLabel() {
            public String getText() {
                int i = pane.indexOfTabComponent(ButtonTabComponentSemControle.this);
                if (i != -1) {
    ...
    private class TabButton extends JButton implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            int i = tabFrame2.indexOfTabComponent(ButtonTabComponentSemControle.this);
