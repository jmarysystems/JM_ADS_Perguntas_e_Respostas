...
import leitura_e_aprendizagem_menu_e_submenu.Submenu_2_JM_Criar_Leitura_e_Aprendizagem;
...
public class Menu_1_JM_Perguntas_e_Respostas extends javax.swing.JPanel {
     ...
     * @param Home2
     */
    public Menu_1_JM_Perguntas_e_Respostas( Home Home2 ) {
        initComponents();
    ...
    private void initComponents() {
        ...
        menu_ajuda1.setText("Ciências");
        menu_ajuda1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                menu_ajuda1MouseEntered(evt);
            }
            public void mousePressed(java.awt.event.MouseEvent evt) {
                menu_ajuda1MousePressed(evt);
            }
        });
        menu_ajuda1.add(jSeparator5);

        jMenuItem7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/home_controle_menus_norte/imagens/iconeAlfabetização.png"))); // NOI18N
        jMenuItem7.setText("Leitura e Aprendizagem");
        ...
        menu_ajuda1.add(jMenuItem7);

        Barra_Menu.add(menu_ajuda1);
        ...
        jMenuItem8.setText("Matéria/Categoria/Subcategoria/Assunto");
    ...
    private void menu_ajuda1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_menu_ajuda1MouseEntered
        // TODO add your handling code here:
    }//GEN-LAST:event_menu_ajuda1MouseEntered
    ...
    private void jMenuItem8MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenuItem8MousePressed
        ...
        try{
            ...
            Home.adicionar_SubMenu(new Submenu_2_JM_Criar_Leitura_e_Aprendizagem( Home ) );
